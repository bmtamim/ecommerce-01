            ...
            <div class="header-top-inner">
                <div class="cnt-account">
                    <ul class="list-unstyled">
                        @auth('web')
                            <li><a href="{{ route('frontend.wishlists') }}"><i
                                        class="icon fa fa-heart"></i>{{ __('Wishlist') }}</a></li>
                        @endauth
                        <li><a href="{{ route('frontend.cart.index') }}"><i class="icon fa fa-shopping-cart"></i>My Cart</a>
                        </li>
                        @auth('web')
                            <li><a href="{{ route('frontend.checkout.index') }}"><i class="icon fa fa-check"></i>{{ __('Checkout') }}</a></li>
                        @endauth
                        @guest('web')
                            <li><a href="{{ route('login') }}"><i class="icon fa fa-lock"></i>{{ __('Login') }}</a></li>
                        @else
                            <li><a href="{{ route('frontend.dashboard.index') }}"><i
                ...
                <div class="col-xs-12 col-sm-12 col-md-2 animate-dropdown top-cart-row">
                    ...
                    <div class="dropdown dropdown-cart"><a href="#" class="dropdown-toggle lnk-cart"
                            ...
                            <div class="items-cart-inner">
                                ...
                                <div class="basket-item-count"><span class="count">{{ Cart::count() }}</span>
                                </div>
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <div class="cart-items-wrapper">
                                    @forelse($cartValue as $cartProducts)
                                        <div class="cart-item product-summary" style="margin-bottom: 10px">
                                            <div class="row">
                                                <div class="col-xs-4">
                                                    <div class="image"><a
                                                            href="{{ $cartProducts->options['slug'] ? route('frontend.product.details',$cartProducts->options['slug']) : '#' }}"><img
                                                                src="{{ $cartProducts->options['image'] ? asset('storage/products/'.$cartProducts->options['image']) : placeholderImage($cartProducts->name) }}"
                                                                alt=""></a></div>
                                                </div>
                                                <div class="col-xs-7">
                                                    <h3 class="name"><a
                                                            href="{{ $cartProducts->options['slug'] ? route('frontend.product.details',$cartProducts->options['slug']) : '#' }}">{{ $cartProducts->name }}</a>
                                                    </h3>
                                                    <div class="price">${{ $cartProducts->price }}
                                                        * {{ $cartProducts->qty }}</div>
                                                </div>
                                                <div class="col-xs-1 action"><a href="#"
                                                                                onclick="event.preventDefault(); removeCart('{{ $cartProducts->rowId }}')"><i
                                ...
                                <div class="clearfix cart-total">
                                    <div class="pull-right"><span class="text">Sub Total :</span><span
                                            id="basket-cart-subtotal" class='price'>${{ Cart::subtotal() }}</span>
                                    </div>
                                    <div class="clearfix"></div>
                    ...
                    <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
                        <div class="nav-outer">
                            <ul class="nav navbar-nav">
                                <li class="dropdown {{ request()->url() == route('frontend.home') ? 'active' : '' }}"><a
                                        href="{{ route('frontend.home') }}">{{ __('Home') }}</a></li>
