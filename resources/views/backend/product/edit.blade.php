                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-7">
                                                            <input type="number" name="regular_price" id="regular_price"
                                                                   class="form-control"
                                                                   value="{{ $product->meta->regular_price ?? old('regular_price') }}">
                                                        </div>
                                                    </div>
                                                    @error('regular_price')
                                                    <p class="m-0 text-danger">{{ $message }}</p>
                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-7">
                                                            <input type="number" name="sale_price" id="sale_price"
                                                                   class="form-control"
                                                                   value="{{ $product->meta->sale_price ?? old('sale_price') }}">
                                                        </div>
                                                        <div class="col-2">
                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-7">
                                                            <input type="text" name="sku" id="sku"
                                                                   class="form-control"
                                                                   value="{{ $product->meta->sku ?? old('sku') }}">
                                                        </div>
                                                    </div>
                                                    @error('sku')
                                                    <p class="m-0 text-danger">{{ $message }}</p>
                                                        ...
                                                        <div class="col-7">
                                                            <div class="checkbox">
                                                                <input type="checkbox" name="manage_stock"
                                                                       id="manage_stock" {{ $product->meta->manage_stock ? 'checked' : '' }}>
                                                                <label
                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-7">
                                                            <select name="stock_status" id="stock_status"
                                                                    class="form-control">
                                                                <option
                                                                    value="instock" {{ $product->meta->stock_status == 'instock' ? 'selected' : '' }}>{{ __('In stock') }}</option>
                                                                <option
                                                                    value="outofstock" {{ $product->meta->stock_status == 'outofstock' ? 'selected' : '' }}>{{ __('Out Of stock') }}</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    @error('stock_status')
                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-7">
                                                            <input type="number" name="stock_quantity" id="stock_quantity"
                                                                   class="form-control"
                                                                   value="{{ $product->meta->stock_qty ?? old('stock_qty') }}">
                                                        </div>
                                                    </div>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <textarea name="short_description" id="short_description" rows="5"
                                              class="form-control">{{ $product->short_description ?? old('short_description') }}</textarea>
                                </div>
                            </div>
                        </div>
                        <!-- Product Card Three-->
                                        ...
                                        <div class="form-group">
                                            <div class="checkbox">
                                                <input type="checkbox" name="hot_deals"
                                                       id="hot_deals" {{ $product->hot_deals ? 'checked' : '' }}>
                                                <label
                                        ...
                                        <div class="form-group">
                                            <div class="checkbox">
                                                <input type="checkbox" name="special_deals"
                                                       id="special_deals" {{ $product->special_deals ? 'checked' : '' }}>
                                                <label
                                        ...
                                        <div class="form-group">
                                            <div class="checkbox">
                                                <input type="checkbox" name="special_offers"
                                                       id="special_offers" {{ $product->special_offers ? 'checked' : '' }}>
                                                <label
                            ...
                            <div class="card-body">
                                ...
                                <div id="preview-gallery">
                                    @foreach($product->gallery_image as $gallery_image)
                                        <img src="{{ asset('storage/products/gallery/'.$gallery_image->image) }}"
                                             width="80" height="80">
                                    @endforeach
                                </div>
                                @error('image_gallery.*')
...
@push('scripts')
    ...
    <script>
        ...
        jQuery('#sale_start').datetimepicker({
            ...
            formatDate: 'd-m-Y',
            formatTime: 'h:i a',
            defaultDate: '{{ \Carbon\Carbon::parse($product->meta->sale_start)->format('d-m-Y') }}',
            defaultTime: '{{ \Carbon\Carbon::parse($product->meta->sale_start)->format('h:i a') }}',
            yearStart: 2020,
            step: 30,
        ...
        jQuery('#sale_end').datetimepicker({
            ...
            formatDate: 'd-m-Y',
            formatTime: 'h:i a',
            defaultDate: '{{ \Carbon\Carbon::parse($product->meta->sale_end)->format('d-m-Y') }}',
            defaultTime: '{{ \Carbon\Carbon::parse($product->meta->sale_end)->format('h:i a') }}',
            yearStart: 2020,
